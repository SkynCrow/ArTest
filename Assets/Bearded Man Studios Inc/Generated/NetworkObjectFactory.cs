			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case ExampleProximityPlayerNetworkObject.IDENTITY:
						...
						break;
					case exNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new exNetworkObject(networker, id, frame);
						break;
					case GameInitNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new GameInitNetworkObject(networker, id, frame);
						break;
					case GameLobbyNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new GameLobbyNetworkObject(networker, id, frame);
						break;
